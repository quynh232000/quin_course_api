                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            <thead style="background-color: rgba(22,22,24,.12)">
                                <tr>
                                    <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7"><span
                                            class="me-4">Id</span> Author</th>
                                ...
                                @foreach ($users as $item)
                                    <tr>
                                            ...
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div>
                                                    <img src="{{ $item->avatar_url }}"
                                                        class="avatar avatar-sm me-3 object-fit-cover" alt="user1">
                                                </div>
                                        ...
                                        <td>
                                            ...
                                            <p class="text-xs text-secondary mb-0 pt-1 d-flex gap-1"
                                        ...
                                        <td class="align-middle text-center">
                                            <span
                                                class="text-secondary text-xs font-weight-bold">{{ explode(' ', $item->created_at)[0] }}</span>
                                        </td>
                                        <td class="align-middle ">
                                            <a href="/users/{{ $item->uuid }}"
                                                class="text-white font-weight-bold  text-xs mb-0 btn btn-sm btn-primary ms-2 py-2 px-3"
