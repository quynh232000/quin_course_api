                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="d-flex align-items-center">
                                <a href="/blogs/create" class="btn btn-info"><i class="fa-solid fa-plus me-2"></i>Add
                                    Blog</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @forelse ($data as $item)
                                        <tr class="bg-hover-danger" style=":hover{background-color:red}">
                                                ...
                                                <div class="d-flex justify-content-center">
                                                    <p style="width:64px;height:52px" class="text-sm font-weight-bold mb-0">
                                                        <img width="100%" height="100%"
                                                            src="{{ $item->thumbnail_url && $item->thumbnail_url != '' ? $item->thumbnail_url : 'https://img.freepik.com/free-vector/gradient-no-photo-sign-design_23-2149288316.jpg' }}"
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <p class="text-sm font-weight-bold mb-0"> {{ $item->from }}</p>
                                                </div>
                                            </td>

                                            <td class="">
                                                <div class="d-flex justify-content-center"><span
                                                        class="text-xs font-weight-bold "> <span class="text-xxs badge badge-sm bg-gradient-info">
                                                            {{ $item->is_show ? 'Published' : 'Editing' }}</span></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex justify-content-center">
                                                    <span class="text-xxs badge badge-sm bg-gradient-success">
                                                        {{ $item->is_published ? 'Show' : 'Hidden' }}</span>
                                                </div>
                                            </td>
                                            <td class="align-middle text-center">
                                                <div class="d-flex align-items-center justify-content-center gap-2 ">
                                                    <a href="{{ route('admin.blog.update', ['id' => $item->id]) }}"
